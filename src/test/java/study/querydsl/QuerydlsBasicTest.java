...
public class QuerydlsBasicTest {
    ...
    @Test
    public void startQuerdsl() throws Exception {
        //member1을 찾아라.
    ...
    public void fetchJoinNo() throws Exception {
        ...
        assertThat(loaded).as("aa").isFalse();
    ...
    public void fetchJoinUse() throws Exception {
        ...
        boolean loaded = emf.getPersistenceUnitUtil().isLoaded(findMember.getTeam());
        assertThat(loaded).as("aa").isTrue();
    }
    ...
    @Test
    public void dynamicQuery_BooleanBulider() throws Exception {

        //null값이 들어올수 있으므로 래퍼타입으로 선언언
